      ...
      <PublicLayout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-md px-6">
            ...
            <p className="text-[#888] mb-6">Doc not found. Create a file in <code className="bg-[#0a0a0a] px-2 py-0.5 text-sm font-mono">content/docs/</code> to add it.</p>
            <Link href="/docs" className="inline-block border border-white text-white px-8 py-3 text-xs uppercase tracking-[0.15em] hover:bg-white hover:text-black transition-all duration-200">
              Back to Docs
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <aside className="lg:w-56 shrink-0">
              <nav className="lg:sticky lg:top-28 space-y-1">
                <Link href="/docs" className="block text-white text-sm font-semibold uppercase tracking-[0.15em] mb-4">
                  Docs
                </Link>
                {allDocs.map((d) => (
                  <Link
