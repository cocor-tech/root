    ...
    <PublicLayout>
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-[#555] text-[10px] uppercase tracking-[0.2em] mb-4">/ Brands / Exit Strategy</p>
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">Exit Strategy</h1>
          ...
          <div className="space-y-6 mb-12">
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">When We Sell</h2>
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">How We Package</h2>
              <ul className="space-y-2 text-[#888] text-sm">
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Valuation Multiples</h2>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-white font-semibold">Content Sites</p>
                  <p className="text-[#888]">25-40x monthly revenue</p>
                </div>
                <div>
                  <p className="text-white font-semibold">SaaS Products</p>
                  <p className="text-[#888]">10-20x monthly revenue</p>
                </div>
                <div>
                  <p className="text-white font-semibold">E-commerce</p>
                  <p className="text-[#888]">15-30x monthly net profit</p>
                </div>
                <div>
                  <p className="text-white font-semibold">Premium Domains</p>
                  <p className="text-[#888]">Valuation based on comparable sales</p>
                </div>
              </div>
            </div>

            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Sale Channels</h2>
              <ul className="space-y-2 text-[#888] text-sm">
