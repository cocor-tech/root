    ...
    <PublicLayout>
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-[#555] text-[10px] uppercase tracking-[0.2em] mb-4">/ Brands / Philosophy</p>
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">Our Philosophy</h1>
          ...
          <div className="space-y-8">
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Digital Real Estate Compounds</h2>
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Brands are Moats</h2>
              <p className="text-[#888] text-sm leading-relaxed">
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Value Creation, Not Speculation</h2>
              <p className="text-[#888] text-sm leading-relaxed">
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Patient Capital</h2>
              <p className="text-[#888] text-sm leading-relaxed">
