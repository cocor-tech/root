    ...
    <PublicLayout>
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-[#555] text-[10px] uppercase tracking-[0.2em] mb-4">/ Agency / Services</p>
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">Custom Software Development</h1>
          ...
          <div className="space-y-6 mb-16">
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">What We Build</h2>
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Our Approach</h2>
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Technologies</h2>
              <p className="text-[#888] text-sm">Next.js, React, TypeScript, Go, Rust, Python, PostgreSQL, Redis, Docker, Stellar/Soroban, Tailwind CSS, and more.</p>
            </div>

            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">Pricing</h2>
              <p className="text-[#888] text-sm">Project-based pricing from $20K. Contact us for a quote tailored to your scope.</p>
            </div>
          </div>
