    ...
    <PublicLayout>
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">Legacy Modernization</h1>
          ...
          <div className="space-y-6 mb-16">
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              <h2 className="text-white font-semibold mb-3">What We Modernize</h2>
            ...
            <div className="border border-[#1a1a1a] bg-[#0a0a0a] p-6 md:p-8">
              ...
              <p className="text-[#888] text-sm">Project-based from $30K. Pricing depends on system complexity and migration scope.</p>
            </div>
          </div>
