    ...
    <PublicLayout>
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-[#555] text-[10px] uppercase tracking-[0.2em] mb-4">/ Agency / Process</p>
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">Our Process</h1>
          <p className="text-[#888] text-sm md:text-base max-w-xl mb-16 leading-relaxed">How we deliver projects, from first conversation to ongoing partnership.</p>

          <div className="space-y-px bg-[#1a1a1a]">
            {steps.map((step) => (
              <div key={step.num} className="bg-[#0a0a0a] p-6 md:p-8 flex gap-6">
                <span className="text-[#333] text-2xl font-mono shrink-0 w-10">{step.num}</span>
                <div>
